...
- (BOOL)shouldAutorotateToInterfaceOrientation:(UIInterfaceOrientation)interfaceOrientation {
	...
	CGSize navigationBarSize = [_navBar sizeThatFits:boundsSize];
	_navBar.frame = CGRectMake(0, 0, navigationBarSize.width, navigationBarSize.height);
	_webView.frame = CGRectMake(0, navigationBarSize.height, boundsSize.width, (boundsSize.height - navigationBarSize.height));
