//
//  PageOrientationViewController.m
//  Note Safe
//
//  Created by Harrison White on 12/7/11.
...
@implementation PageOrientationViewController
...
- (void)viewDidLoad {
	...
	selectedRow = [[NSUserDefaults standardUserDefaults]integerForKey:kPrintOrientationKey];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	cell.textLabel.text = [kPrintOrientationArray objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if (indexPath.row != selectedRow) {
		...
		[defaults setInteger:indexPath.row forKey:kPrintOrientationKey];
