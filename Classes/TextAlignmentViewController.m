...
- (void)viewDidLoad {
	...
	selectedRow = [[NSUserDefaults standardUserDefaults]integerForKey:kPrintTextAlignmentKey];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	cell.textLabel.text = [kDetailPrintTextAlignmentArray objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if (indexPath.row != selectedRow) {
		...
		[defaults setInteger:indexPath.row forKey:kPrintTextAlignmentKey];
