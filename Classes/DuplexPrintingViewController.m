//
//  DuplexPrintingViewController.m
//  Note Safe
//
...
@implementation DuplexPrintingViewController
...
- (void)viewDidLoad {
	...
	selectedRow = [[NSUserDefaults standardUserDefaults]integerForKey:kPrintDuplexKey];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	cell.textLabel.text = [kPrintDuplexArray objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if (indexPath.row != selectedRow) {
		...
		[defaults setInteger:indexPath.row forKey:kPrintDuplexKey];
